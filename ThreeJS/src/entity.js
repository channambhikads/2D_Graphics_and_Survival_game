...
export const entity = (() => {
  ...
  class Entity {
    ...
    SetParent(manager) {
      ...
      this._parent = manager; // <-- Add this line
    }
    ...
    FindEntity(n) {
      if (!this._parent) {
        console.warn('Entity.FindEntity called but _parent is null');
        return null;
      }
  ...
  class Component {
    ...
    GetComponent(n) {
      if (!this._parent) {
        console.warn('Component.GetComponent called but _parent is null');
        return null;
      }
