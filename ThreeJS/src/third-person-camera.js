...
export const third_person_camera = (() => {
  ...
  class ThirdPersonCamera extends entity.Component {
    constructor(params) {
      ...
      this._orbitSpeed = 1.0; // Try increasing from 0.5 to 1.0 or higher
      ...
      this._sphericalCoords = {
        radius: 15, // Try lowering from 25 to 15 or 10
    ...
    Update(timeElapsed) {
      ...
      const t = 1.0 - Math.pow(0.05, timeElapsed); // Try changing 0.01 to 0.05 for less smoothing (snappier camera)
